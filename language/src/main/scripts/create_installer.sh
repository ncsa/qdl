...
# It will take the source directories and create the distro tree,
# If there is a source other than the current distro, it will take
# those as overrides and add those files.
...
mkdir "lib"
cp "$QDL_SOURCES/target/qdl.jar" lib
cd lib
