...
is located in
~/apps/java/TokenMakerMaker
and is invoked with

~/apps/java/TokenMakerMaker-master/build/install/tmm$ java -jar tokenMakerMaker-3.1.2-SNAPSHOT.jar

Load into it the syntax file
...
that the GUI is woefully incomplete and it does nto seem to store its own state right,
...
name.) There are complete lists of functions and operators at
...
This generates the classes in this directory. Then it
