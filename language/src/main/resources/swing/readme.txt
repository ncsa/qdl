...
7. IMPORTANT!!! The new generated QDLSyntax.* files are in /tmp/org/qdl_lang/gui/flex/ and you should
   issue a copy to the main code:

cp /tmp/org/qdl_lang/gui/flex/QDLSyntax.* /home/ncsa/dev/ncsa-git/qdl/language/src/main/java/org/qdl_lang/gui/flex
